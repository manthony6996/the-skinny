...
function breakingBanner(articles, color) {
  ...
  return `
    <div style="background:${color};color:#fff;padding:.6rem 1rem;border-radius:6px;margin-bottom:1rem;font-size:.85rem;font-weight:700;display:flex;align-items:center;gap:.5rem;">
